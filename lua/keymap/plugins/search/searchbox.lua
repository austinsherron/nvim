...
local function call(func, opts)
  return function() Search[func](opts or {}) end
end
...
KM:bind({
  ...
  { '?', call('incsearch', { reverse = true }), { desc = 'reverse incsearch' }, { 'n', 'v' }},
  ...
  { '<leader>?',  call('match_all', { reverse = true }), { desc = 'reverse match all search' }, { 'n', 'v' }},
  ...
  { '<leader>>', call('replace', { force = true }), { desc = 'find and replace (just do it)' }, { 'n', 'v' }},
})
