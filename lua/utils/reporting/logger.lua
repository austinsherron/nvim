...
---@alias NvimLoggerOpts { persistent: boolean|nil, user_facing: boolean|nil }
...
--- Constructor
---
---@param log_level LogLevel|nil: the current log level optional
---@param default_opts NvimLoggerOpts|nil: default logger options can be overridden
--- via method level options arguments
...
---@param opts NvimLoggerOpts|nil: options that control logging behavior
